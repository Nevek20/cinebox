<footer class="footer">    
    <main class="container">        
        ...
        <div class=" footer-bottom">            
            <p>&copy; 2025. Este site foi desenvolvido com a turma de TI24. Não reservamos os direitos e os valores                apresentados são meramente ilustrativos para fins didáticos.</p>        
        </div>    
    </main>
</footer>
</body>
